...
<script>
	$(document).ready(function(){
		...
		jQuery('#ampaginationsm').on('am.pagination.change',function(e){
	           ...
	           $(location).attr('href', "http://localhost:8899/model2/admin/notice_list?rpage="+e.page);         
	    });
	...
	<div class="content">
		<section class="login">
			...
			<table class="board_list">
				<tr>
					<td colspan="4"><a href="notice_write"><button
								type="button" class="btn_style2">글쓰기</button></a></td>
				</tr>
				<tr>
				...
				<c:forEach var="board" items="${list}">
					<tr>
						<td>${board.rno}</td>
						<td><a href="notice_content?bid=${board.bid}">${board.btitle}</a></td>
						<td>${board.bhit}</td>
						<td>${board.bdate}</td>
					</tr>
				</c:forEach>
