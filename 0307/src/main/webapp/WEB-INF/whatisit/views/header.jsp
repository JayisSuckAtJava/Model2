...
<body>
	<header>
		<div class="header_menu">
			...
			<div class="relative">
				<a href="http://localhost:8899/model2/main" target="_parent">
					<img src="http://localhost:8899/model2/resources/images/h1_cgv.png">
				</a>
				<div>
					<img src="http://localhost:8899/model2/resources/images/h2_cultureplex.png">
					<nav>
						<ul>
							<li><a href="">영화</a></li>
							<li><a href="">예매</a></li>
